...
reddit = praw.Reddit (client_id = '42YrBtoTC7thlw',
                    client_secret = 'Z56RT-vfti48zO-fBCEaVSgDdUXQ1w',
                    user_agent = 'scraperv1',
                    username = 'stantwiceeeeeeeee',
                    password = 'polverin')
